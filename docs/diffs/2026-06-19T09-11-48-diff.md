...
+note.md
+
+# Scripts (si ce sont des scripts temporaires ou locaux)
+/scripts/
+
+# Fichiers de configuration locaux (optionnel)
...
new file mode 100644
index 0000000..5806831
--- /dev/null
+++ b/composer.json
@@ -0,0 +1,42 @@
+{
+    "name": "andydefer/authentication-kit",
+    "description": "Headless authentication kit for Laravel built on Nemesis and Laravel Actions",
+    "type": "library",
+    "license": "MIT",
+    "authors": [
+        {
...
+    "autoload": {
+        "psr-4": {
+            "AndyDefer\\AuthenticationKit\\": "src/"
+        }
+    },
+    "autoload-dev": {
+        "psr-4": {
+            "AndyDefer\\AuthenticationKit\\Tests\\": "tests/"
+        }
+    },
+    "extra": {
+        "laravel": {
+            "providers": [
+                "AndyDefer\\AuthenticationKit\\AuthenticationKitServiceProvider"
+            ]
+        }
+    },
...
+    ],
+    "content-hash": "a181b8beb025edb7700b58b48e674ad5",
+    "packages": [
+        {
+            "name": "andydefer/data-validator",
+            "version": "v1.0.1",
+            "source": {
+                "type": "git",
+                "url": "https://github.com/andydefer/data-validator.git",
+                "reference": "c34381276ba89e4e5c08247d76f30edaf60d3305"
+            },
+            "dist": {
+                "type": "zip",
+                "url": "https://api.github.com/repos/andydefer/data-validator/zipball/c34381276ba89e4e5c08247d76f30edaf60d3305",
+                "reference": "c34381276ba89e4e5c08247d76f30edaf60d3305",
+                "shasum": ""
+            },
+            "require": {
...
+                {
+                    "name": "andydefer",
+                    "email": "andydefer@gmail.com",
+                    "role": "Developer"
+                }
+            ],
+            "description": "Validates and sanitizes structured data arrays with configurable constraints (size, depth, nesting, key/value types).",
+            "keywords": [
+                "array-validator",
+                "constraints",
+                "data-filter",
...
+            ],
+            "support": {
+                "issues": "https://github.com/andydefer/data-validator/issues",
+                "source": "https://github.com/andydefer/data-validator/tree/v1.0.1"
+            },
+            "time": "2026-06-08T07:25:25+00:00"
+        },
+        {
...
+                "reference": "1e8bb1bf252833a31601bd22f9e55415596333da"
+            },
+            "dist": {
+                "type": "zip",
+                "url": "https://api.github.com/repos/andydefer/domain-structures/zipball/1e8bb1bf252833a31601bd22f9e55415596333da",
+                "reference": "1e8bb1bf252833a31601bd22f9e55415596333da",
+                "shasum": ""
+            },
+            "require": {
...
+                "source": "https://github.com/andydefer/domain-structures/tree/v1.19.1"
+            },
+            "time": "2026-06-16T14:37:01+00:00"
+        },
+        {
+            "name": "andydefer/laravel-actions",
+            "version": "v2.4.5",
+            "source": {
+                "type": "git",
+                "url": "https://github.com/andydefer/laravel-actions.git",
+                "reference": "41a4588a33eadf6f558a1298ce3d1824a63e175d"
+            },
+            "dist": {
+                "type": "zip",
+                "url": "https://api.github.com/repos/andydefer/laravel-actions/zipball/41a4588a33eadf6f558a1298ce3d1824a63e175d",
+                "reference": "41a4588a33eadf6f558a1298ce3d1824a63e175d",
+                "shasum": ""
+            },
+            "require": {
+                "andydefer/domain-structures": "^1.19.1",
...
+                "laravel": {
+                    "providers": [
+                        "AndyDefer\\Actions\\ActionServiceProvider"
+                    ]
+                }
+            },
+            "autoload": {
...
+                }
+            ],
+            "description": "Action-oriented architecture for Laravel applications",
+            "support": {
+                "issues": "https://github.com/andydefer/laravel-actions/issues",
+                "source": "https://github.com/andydefer/laravel-actions/tree/v2.4.5"
+            },
+            "time": "2026-06-17T12:43:32+00:00"
+        },
+        {
...
+                "reference": "05cff11ecf20b4998880f7643734cd3c2c0f97fd"
+            },
+            "dist": {
+                "type": "zip",
+                "url": "https://api.github.com/repos/andydefer/laravel-directive/zipball/05cff11ecf20b4998880f7643734cd3c2c0f97fd",
+                "reference": "05cff11ecf20b4998880f7643734cd3c2c0f97fd",
+                "shasum": ""
+            },
+            "require": {
+                "andydefer/php-services": "^1.1.1",
+                "andydefer/php-signature-parser": "^0.2.1",
+                "laravel/framework": "^12.0|^13.0|^14.0|^15.0",
+                "php": ">=8.1"
+            },
+            "require-dev": {
...
+                "source": "https://github.com/andydefer/laravel-directive/tree/v3.30.1"
+            },
+            "time": "2026-06-19T07:49:26+00:00"
+        },
+        {
...
+            "source": {
+                "type": "git",
+                "url": "https://github.com/andydefer/laravel-nemesis.git",
+                "reference": "3ad938410afe300e85b211e943655ac3a2d86130"
+            },
+            "dist": {
+                "type": "zip",
+                "url": "https://api.github.com/repos/andydefer/laravel-nemesis/zipball/3ad938410afe300e85b211e943655ac3a2d86130",
+                "reference": "3ad938410afe300e85b211e943655ac3a2d86130",
+                "shasum": ""
+            },
+            "require": {
+                "andydefer/data-validator": "^1.0.1",
+                "andydefer/laravel-actions": "^2.4.5",
+                "andydefer/laravel-directive": "^3.30.0",
+                "andydefer/laravel-repository": "^2.8.6",
+                "andydefer/php-services": "^1.1.1",
...
+                "laravel": {
+                    "providers": [
+                        "AndyDefer\\Nemesis\\NemesisServiceProvider"
+                    ]
+                }
+            },
+            "autoload": {
+                "psr-4": {
+                    "AndyDefer\\Nemesis\\": "src/"
+                }
+            },
+            "notification-url": "https://packagist.org/downloads/",
+            "license": [
...
+            "support": {
+                "issues": "https://github.com/andydefer/laravel-nemesis/issues",
+                "source": "https://github.com/andydefer/laravel-nemesis/tree/v1.6.11"
+            },
+            "time": "2026-06-19T07:37:08+00:00"
+        },
+        {
+            "name": "andydefer/laravel-repository",
+            "version": "v2.8.6",
+            "source": {
+                "type": "git",
+                "url": "https://github.com/andydefer/laravel-repository.git",
+                "reference": "c01cba8b6ed6feb48c5fb6d61d440cc8c39371f3"
+            },
+            "dist": {
+                "type": "zip",
+                "url": "https://api.github.com/repos/andydefer/laravel-repository/zipball/c01cba8b6ed6feb48c5fb6d61d440cc8c39371f3",
+                "reference": "c01cba8b6ed6feb48c5fb6d61d440cc8c39371f3",
+                "shasum": ""
+            },
+            "require": {
+                "andydefer/php-vo": "^0.9.3",
+                "laravel/framework": "^12.0|^13.0|^14.0|^15.0",
+                "php": "^8.1"
+            },
+            "require-dev": {
...
+                "laravel": {
+                    "providers": [
+                        "AndyDefer\\Repository\\RepositoryServiceProvider"
+                    ]
+                }
+            },
+            "autoload": {
+                "psr-4": {
+                    "AndyDefer\\Repository\\": "src/"
+                }
+            },
+            "notification-url": "https://packagist.org/downloads/",
+            "license": [
...
+                }
+            ],
+            "description": "A lightweight, type-safe repository pattern implementation for Laravel",
+            "support": {
+                "issues": "https://github.com/andydefer/laravel-repository/issues",
+                "source": "https://github.com/andydefer/laravel-repository/tree/v2.8.6"
+            },
+            "time": "2026-06-16T08:34:43+00:00"
+        },
+        {
+            "name": "andydefer/php-services",
+            "version": "v1.1.1",
+            "source": {
+                "type": "git",
+                "url": "https://github.com/andydefer/php-services.git",
+                "reference": "a8d73e8fcad39b2487da778799bed5950fbb4d5b"
+            },
+            "dist": {
+                "type": "zip",
+                "url": "https://api.github.com/repos/andydefer/php-services/zipball/a8d73e8fcad39b2487da778799bed5950fbb4d5b",
+                "reference": "a8d73e8fcad39b2487da778799bed5950fbb4d5b",
+                "shasum": ""
+            },
+            "require": {
...
+                }
+            ],
+            "description": "Collection of reusable services for PHP and Laravel applications including model transformation, caching, and common business logic",
+            "support": {
+                "issues": "https://github.com/andydefer/php-services/issues",
+                "source": "https://github.com/andydefer/php-services/tree/v1.1.1"
+            },
+            "time": "2026-06-17T12:59:40+00:00"
+        },
+        {
+            "name": "andydefer/php-signature-parser",
+            "version": "v0.2.2",
+            "source": {
+                "type": "git",
+                "url": "https://github.com/andydefer/php-signature-parser.git",
+                "reference": "a463095322b1d6f8842a821e88e766ff4ed5c2fb"
+            },
+            "dist": {
+                "type": "zip",
+                "url": "https://api.github.com/repos/andydefer/php-signature-parser/zipball/a463095322b1d6f8842a821e88e766ff4ed5c2fb",
+                "reference": "a463095322b1d6f8842a821e88e766ff4ed5c2fb",
+                "shasum": ""
+            },
+            "require": {
...
+                }
+            ],
+            "description": "A flexible signature parser for CLI commands",
+            "support": {
+                "issues": "https://github.com/andydefer/php-signature-parser/issues",
+                "source": "https://github.com/andydefer/php-signature-parser/tree/v0.2.2"
+            },
+            "time": "2026-06-19T07:49:34+00:00"
+        },
+        {
...
+                "reference": "5ed2c9ad7d00490d09383f7cd59701927dec30a9"
+            },
+            "dist": {
+                "type": "zip",
+                "url": "https://api.github.com/repos/andydefer/php-vo/zipball/5ed2c9ad7d00490d09383f7cd59701927dec30a9",
+                "reference": "5ed2c9ad7d00490d09383f7cd59701927dec30a9",
+                "shasum": ""
+            },
+            "require": {
...
+                "source": "https://github.com/andydefer/php-vo/tree/v0.9.4"
+            },
+            "time": "2026-06-19T07:49:50+00:00"
+        },
+        {
+            "name": "brick/math",
+            "version": "0.14.8",
